...
from main.util.fast_methods import _compute_val_metrics
from main.util.fast_methods import _initialization
from main.util.fast_methods import _run_epoch
from main.util.fast_methods import _shuffle
...
if __name__ == '__main__':
    ...
    ratings.rename(columns={'user': 'u_id', 'item': 'i_id'}, inplace=True)
    print((ratings.head()))
